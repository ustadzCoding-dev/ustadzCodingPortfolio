          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="md:hidden border-t border-border/60 bg-background/55 backdrop-blur-xl overflow-hidden rounded-b-3xl"
              >
                  ...
                  <div className="rounded-2xl border border-border/60 bg-card/25 p-2 flex flex-col gap-1">
                    {links.map((link) => (
                      ...
                      >
                        ...
                        <span className="absolute left-3 right-3 -bottom-px h-px bg-gradient-to-r from-transparent via-primary/80 to-transparent opacity-0 data-[active=true]:opacity-100 transition-opacity" />
                      </a>
                    ))}
                  </div>
                </div>
